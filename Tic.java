...
public class Tic {
    ...
    public static boolean checkComputerWin(FieldParts[] list) {
        ...
        int[] diagonal1 = {0,4,8};
        int[] diagonal2 = {2,4,6};
        if (checkArrays(checkPlacedFieldsX(list), row1) ||
                checkArrays(checkPlacedFieldsX(list), row2) ||
                checkArrays(checkPlacedFieldsX(list), row3) ||
                checkArrays(checkPlacedFieldsX(list), column1) ||
                checkArrays(checkPlacedFieldsX(list), column2) ||
                checkArrays(checkPlacedFieldsX(list), column3) ||
                checkArrays(checkPlacedFieldsX(list), diagonal1) ||
                checkArrays(checkPlacedFieldsX(list), diagonal2)
                ){
        ...
        while (gameStatus) {
                ...
                while (!playerTurn) {
                    ...
                    if (hitReaction) {
                        ...
                        Object[] conditionArray = new Object[1];
